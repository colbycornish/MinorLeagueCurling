...
//         public void UpdateMovementAll()
//         {
//             Vector3 currentPos = _Character.Animancer.transform.position; //_Character.transform.position; // Or agent.nextPosition if updatePosition is false
//             Vector3 targetPos = _Character.NavAgent.nextPosition;
//             Vector3 direction = targetPos - currentPos;

//             // Debug.Log("Should move to:" + direction);
//             // if (direction.sqrMagnitude < 0.01f) { // If very close to target
//             //     // Stop or idle
//             //     // Debug.Log("Too close to target to move");
//             //     _Character.NavAgent.velocity = Vector3.zero;
...
//             _Character.NavAgent.speed = _Speed.TargetValue * WalkSpeed; // Animation walk is 0.5
//             _Character.Parameters.Movement.ForwardSpeed = _Speed.TargetValue * WalkSpeed; //7f;
