...
{
    public class TeamBroomLeftSweeperSelectionModalState : ICanvasModalState
    {
        ...
        // [SerializeField] public Action<CurlingBroomSO> OnSelect;
            // controller.Init(
            //     name: c.fullName,
            //     characterId: c.id,
        ...
        /// </summary>
        public override CanvasModalType StateCanvasModalType => CanvasModalType.TeamBroomLeftSweeperSelection;
