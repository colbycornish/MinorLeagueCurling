...
// public class XXXXStoneThrowController : MonoBehaviour
// {
...
//         currentStone = stone.rb;
//         // currentStone.isKinematic = false; // Enable physics on the new stone
        
//         // Debug.Log("🔁 Current stone set: " + currentStone.name);
//     }
