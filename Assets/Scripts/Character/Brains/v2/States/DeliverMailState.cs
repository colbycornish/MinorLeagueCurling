...
(will be included by default on all characters)
  ...
  - The NPC is curling, and is a sweeper, and it's their turn.
...
namespace CharacterNPC.v2
{
    ...
    [AddComponentMenu(Strings.SamplesMenuPrefix + "Character NPC - Deliver Mail State")]
    public class DeliverMailState : CharacterState
    {
        /************************************************************************************************************************/
        ...
        public override ActionType StateActionType => ActionType.DeliverMail;
